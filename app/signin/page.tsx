...
const Page = () => {
  ...
  return (
    loading ? (
      ...
      <>
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark h-screen pt-20">
          <div className="flex flex-wrap items-center">
            <div className="hidden w-full xl:block xl:w-1/2">
              <div className="py-17.5 px-26 text-center">
                ...
                <p className="2xl pr-4 text-center justify-center text-lg font-semibold pb-6">
                  Welcome Back!
                </p>
            ...
            <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
              <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                ...
                <div>
                  ...
                  <div className="mb-5">
                    <button
                      className="w-full cursor-pointer rounded-lg border border-primary bg-blue-300 hover:bg-blue-500 p-4 text-white transition hover:bg-opacity-90"
                      onClick={onLogin}
