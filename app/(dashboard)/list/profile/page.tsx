...
const handleImageChange = async (e: { preventDefault: () => void }) => {
  e.preventDefault();
  // Ensure 'photo' is defined and a valid File object before proceeding.
  if (!photo) {
  ...
  try {
    ...
    data.set('file', photo);  // Add the file to the FormData object.
        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="p-7">
            <div >
              <div className="mb-5.5 flex flex-col gap-5 sm:flex-row">
                <div className="w-full sm:w-1/2 ">
                  ...
                  <div className="relative">
                    <input
                      className="w-full rounded border border-stroke bg-gray py-3 px-3 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4  dark:focus:border-primary"
                      type="text"
                      name="fullName"
                      id="fullName"
              ...
              <div className="flex justify-end gap-4 mt-3 text-white">
                <button
                  className="flex justify-center rounded border bg-red-400 hover:bg-red-600 cursor-pointer border-stroke py-2 px-6 font-medium dark:border-strokedark "
                  onClick={(e)=>handleCancel(e)}
                  >
                  Cancel
                </button>
                <button
                  className="flex justify-center rounded border bg-green-400 hover:bg-green-600 cursor-pointer py-2 px-6 font-medium text-gray "
        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="p-7">
            <form  onSubmit={handleImageChange}>
              ...
              <div className="flex justify-end gap-4 text-white mt-3">
                <button
                  className="flex justify-center rounded border border-stroke py-2 px-6 font-medium bg-red-400 hover:bg-red-600 cursor-pointer dark:border-strokedark "
                  onClick={(e)=>handleCancel(e)}
                >
                  Cancel
                </button>
                <button
                  className="flex justify-center rounded bg-primary py-2 px-6 font-medium text-gray bg-green-400 hover:bg-green-600 cursor-pointer"
                  type="submit"
                >
                  Save
                </button>
