        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5  text-center">
              <p className="2xl pb-4 pr-8 font-semibold text-lg text-center items-center">
                Welcome!
              </p>
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <div>
                ...
                <div className="mb-5">
                  <button 
                  onClick={onSignUp}
                    className="w-full cursor-pointer rounded-lg border border-primary bg-blue-300 hover:bg-blue-500 p-4  transition hover:bg-opacity-90"
